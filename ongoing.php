...
<?php
    ...
    $nextPage = $page + 1;
    $nextApi = "https://webdis-zgj8.onrender.com/$genre?type=2&page=$nextPage";
    $ch = curl_init();
...
<body>
                ...
                <section class="block_area block_area-anime none-bg">
                    <div class="block_area-header block_area-header-tabs">
                        <div class="float-left bah-heading mr-4">
                            <h2 class="cat-heading text-capitalize"> Ongoing :</h2>
                        </div>
    ...
    ?>
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "$api/$genre?type=2&page=$page");
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch, CURLOPT_HEADER, false);
        curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type: application/json"));
